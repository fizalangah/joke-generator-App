...
interface JokeResponse {
  ...
  return (
    <div className="flex justify-center items-center ">
        <div className="bg-white w-[300px] md:w-[400px] lg:w-[450px] h-[300px] md:h-[300px] lg:h-[300px] border-2 rounded-xl mt-[50px] lg:mt-[200px] md:mt-[100px] ">
            ...
            <div className="flex justify-center items-center mt-[20px]"><button onClick={fetchJoke} className=" bg-green-500 border-xl rounded-xl h-[40px] w-[160px]  mt-[30px] text-sm font-semibold ">😂 Get New Joke 😂</button></div>
